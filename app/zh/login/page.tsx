  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      if (!data?.session) {
        ...
        throw new Error('登录成功但会话未能建立，请重试。');
      }
    ...
    <div className="min-h-screen bg-bg-primary flex items-center justify-center px-4">
      ...
      {checking ? (
        <div className="relative glass-card max-w-md w-full p-8 flex items-center justify-center" style={{minHeight: '200px'}}>
          <div className="text-text-secondary">正在检查登录状态...</div>
        </div>
      ) : (
        <div className="relative glass-card max-w-md w-full p-8 page-enter">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="font-display text-2xl font-bold text-gold-primary mt-2">欢迎回来</h1>
            <p className="text-text-secondary text-sm mt-1">登录以继续您的探索之旅</p>
          </div>
