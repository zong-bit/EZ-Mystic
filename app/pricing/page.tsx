...
export default function PricingPage() {
  return (
    <div className="min-h-screen">
      ...
      {/* Pricing Page Section — wrapper for CSS-only enhancements */}
      <div className="pricing-page-section">
        ...
        <section className="py-12 px-6">
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Free */}
            <div className="glass-card pricing-card p-8 flex flex-col">
              ...
              <ul className="text-sm text-text-secondary space-y-3 mb-8 flex-grow">
                <li className="flex items-start gap-2 feature-included">
              ...
              <Link href="/bazi" className="glass w-full text-center py-3 cta-btn-glass transition-all">
                ✦ Start Free
              </Link>
            </div>
            ...
            <div className="glass-card pricing-card p-8 flex flex-col">
              ...
              {/* Deliverables — Pro */}
              <div className="mb-6 p-3 border border-gold-primary/20 rounded bg-gold-primary/5 deliverables-box">
              ...
              <a href={GUMROAD_MONTHLY} target="_blank" rel="noopener noreferrer" className="cta-btn-glass w-full text-center py-3 transition-all">
                Get Destiny Book Monthly →
              </a>
            </div>

            {/* Pro Yearly — Recommended */}
            <div className="glass-card pricing-card pricing-card-recommended p-8 flex flex-col relative">
              <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-gold-primary text-dark px-4 py-1 rounded-full font-semibold badge-best-value">
                ✦ Best Value
              </div>
              ...
              <p className="text-gold-primary text-sm font-semibold mb-1 savings-label">Save 34% — just $6.67/month</p>
              ...
              <a href={GUMROAD_YEARLY} target="_blank" rel="noopener noreferrer" className="btn-primary cta-btn-gold w-full text-center py-3 transition-all">
        ...
        <section className="py-12 px-6">
          <div className="max-w-2xl mx-auto text-center glass-card license-cta-card p-8">
        ...
        <section className="py-16 px-6">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="glass-card p-6 faq-item">
        ...
        {/* Bottom CTA */}
        <section className="py-16 px-6">
          <div className="max-w-3xl mx-auto text-center glass-card bottom-cta-card p-12">
            ...
            <Link href="/bazi" className="btn-primary text-lg px-12 py-4 cta-btn-bottom">
        ...
        <section className="pb-12 px-6">
          <div className="max-w-3xl mx-auto text-center space-y-4 trust-bar">
